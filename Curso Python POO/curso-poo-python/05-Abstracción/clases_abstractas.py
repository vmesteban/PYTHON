from abc import ABC, abstractmethod  # Importa las clases ABC y  // DEPRECATED _abstractclassmethod del módulo abc
...
class Persona(ABC):
    ...
    @classmethod
    @abstractmethod    # //DEPRECATED @abstractclassmethod  # Decorador para definir un método abstracto
